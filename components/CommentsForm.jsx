...
const CommentsForm = ({ slug }) => {
	...
	return (
		<div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
			...
			<div className="grid grid-cols-1 grap-4 mb-4">
				<textarea 
					ref={commentEl} 
			...
			<div className="grid grid-cols-1 grap-4 mb-4">
				<div>
					...
					<label className="text-gray-500 ml-2 cursor-pointer" htmlFor="storeData">Save my e-mail and name for the next time I comment.</label>
				</div>
			</div>
